...
public:
   ...
   * @param filename
   use code in https://github.com/Alkaid-Benetnash/ORB_SLAM2/commit/6fbcaf63dc33c50f0ad7d76ff2c61350aa9b4fdb
 */
...
bool TemplatedVocabulary<TDescriptor,F>::loadFromTextFile(const std::string &filename)
{
    ...
    if (!f.is_open())
    {
        cout << "Couldn't open vocabulary file in path: " << filename;
        exit(1);
    }
    else
    {
...
//add vocabluary binary load/save 
//use code in https://github.com/Alkaid-Benetnash/ORB_SLAM2/commit/6fbcaf63dc33c50f0ad7d76ff2c61350aa9b4fdb
