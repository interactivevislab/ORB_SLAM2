...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "7574ab4d00b683e56adbfdec7da636529dfe65d8"
  WORKING_DIRECTORY "F:/laba_work/v2/ORB_SLAM2/orbslam-windows/Thirdparty/Pangolin/build/external/glew/src/__glew"
...
if("${show_ref_output}" MATCHES "refs/remotes/7574ab4d00b683e56adbfdec7da636529dfe65d8")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "7574ab4d00b683e56adbfdec7da636529dfe65d8")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "7574ab4d00b683e56adbfdec7da636529dfe65d8")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/Perlmint/glew-cmake.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'F:/laba_work/v2/ORB_SLAM2/orbslam-windows/Thirdparty/Pangolin/build/external/glew/src/__glew'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'F:/laba_work/v2/ORB_SLAM2/orbslam-windows/Thirdparty/Pangolin/build/external/glew/src/__glew'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
