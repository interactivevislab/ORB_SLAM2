...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v1.2.8"
  WORKING_DIRECTORY "F:/laba_work/v2/ORB_SLAM2/orbslam-windows/Thirdparty/Pangolin/build/external/zlib/src/__zlib"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.2.8")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.2.8")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/madler/zlib.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'F:/laba_work/v2/ORB_SLAM2/orbslam-windows/Thirdparty/Pangolin/build/external/zlib/src/__zlib'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'F:/laba_work/v2/ORB_SLAM2/orbslam-windows/Thirdparty/Pangolin/build/external/zlib/src/__zlib'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
